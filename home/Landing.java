...
public class Landing implements DataInterface {
	...
	public Landing(double gmax,double gmin,double wsmax,double wsmin,double wdmax,double wdmin, 
	...
	public boolean fileAccess(){
		...
		try{
		    ...
		    FileInputStream fstream = new FileInputStream("C:\\home\\landing.txt");
