...
public class Descent implements DataInterface {
	...
	public Descent(double gmax,double gmin,double wsmax,double wsmin,double wdmax,double wdmin, 
	...
	public boolean fileAccess(){
		...
		try{
		    ...
		    FileInputStream fstream = new FileInputStream("C:\\home\\descent.txt");
